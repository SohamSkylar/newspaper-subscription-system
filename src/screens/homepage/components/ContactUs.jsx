              ...
              <form className="form-box">
                <div className="container-block form-wrapper">
                  ...
                  <div className="btn-wrapper font-face-bwl">
                    <button className="w-[290px] h-[60px]">
                      Submit
                    </button>
                  </div>
                </div>
                ...
                <div className="workik-contact-bigbox">
                  <div className="workik-contact-box">
                    <div className="phone text-box">
                      <img className="contact-svg" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/ET21.jpg" alt='Image1' />
                      <p className="contact-text font-face-bwr">
                        +91 12 3258 5679
                      </p>
                    </div>
                    <div className="address text-box">
                      <img className="contact-svg" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/ET22.jpg" alt='Image2' />
                      <p className="contact-text font-face-bwr">
                        paperportal@mail.com
                      </p>
                    </div>
                    <div className="mail text-box">
                      <img className="contact-svg" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/ET23.jpg" alt='Image3' />
                      <p className="contact-text font-face-bwr">
                  ...
                  <div className="social-media-links">
                    <a href="/">
                      <img className="social-svg" id="is9ym" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/gray-mail.svg" alt='Image4' />
                    </a>
                    <a href="/">
                      <img className="social-svg" id="i706n" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/gray-twitter.svg" alt='Image5' />
                    </a>
                    <a href="/">
                      <img className="social-svg" id="ib9ve" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/gray-insta.svg" alt='Image6' />
                    </a>
                    <a href="/">
                      <img className="social-svg" id="ie9fx" src="https://workik-widget-assets.s3.amazonaws.com/widget-assets/images/gray-fb.svg" alt='Image7' />
                    </a>
                  </div>
                </div>
              </div>
