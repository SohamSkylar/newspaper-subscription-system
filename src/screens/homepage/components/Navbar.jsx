    ...
    <div className='w-screen h-[80px] z-10 bg-zinc-200 fixed drop-shadow-lg'>
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          ...
          <li><Link to="homePage" smooth={true} duration={500} className='hover: cursor-pointer'>Home</Link></li>
          <li><Link to="cardSection" smooth={true} offset={-200} duration={500} className='hover: cursor-pointer'>About</Link></li>
          <li><Link to="support" smooth={true} offset={-50} duration={500} className='hover: cursor-pointer'>Support</Link></li>
          <li><Link to="platforms" smooth={true} offset={-100} duration={500} className='hover: cursor-pointer'>Platforms</Link></li>
          <li><Link to="pricing" smooth={true} offset={-50} duration={500} className='hover: cursor-pointer'>Pricing</Link></li>
          </ul>
        </div>
        ...
        <div className='md:hidden mr-4' onClick={handleClick}>
            {!nav ? <GiHamburgerMenu className='w-5' /> : <GiIvoryTusks className='w-5' />}
